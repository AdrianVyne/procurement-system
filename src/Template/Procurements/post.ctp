        ...
        <div class="content">
            <div class="card card-user">
                <div class="card-header">
                    <h5 class="card-title">Add Procurement</h5>
                </div>
                <div class="card-body">
                    <?= $this->Form->create(null, ['url' => ['controller' => 'Procurements', 'action' => 'post']]) ?>
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="update ml-auto mr-auto">
                            <?= $this->Form->button('Add Procurement', ['class' => 'btn btn-primary btn-round']) ?>
                        </div>
                    </div>
                    <?= $this->Form->end() ?>
                </div>
