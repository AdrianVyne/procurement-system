                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-md-2 col-2">
                                            <div class="avatar">
                                                <img src="../assets/img/faces/ayo-ogunseinde-2.j
               p                                    g" alt="Circle Image"
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 col-7">
                                            Creative Tim
                                            <br />
                                            <span class="text-success"><small>Available</ s mall></span>
                                        </div>
                                        <div class="col-md-3 col-3 text-right">
                                            <btn class="btn btn-sm btn-outline-success btn-round btn-icon"><i
                                                    class="fa fa-envelope"></i></btn>
                                ...
                                <div class="row">
                                    <div class="col-md-5 pr-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" di s abled="" placeholder="Company"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 pl-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeh o lder="Last Name"
                                                value="Faker">
                                        </div>
                                    </div>
                                </div>
